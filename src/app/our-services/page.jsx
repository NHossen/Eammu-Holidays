...
export const metadata = {
  ...
  title: {
    default:
      "Online Leading Travel Agency | Travel Agency in Bangladesh | Visa, Tours & Flights",
    template: "%s | Eammu Holidays Services",
  },

  description:
    "Explore all travel services by Eammu Holidays including visa processing, tour packages, flight booking, Umrah packages, and travel activities. Trusted travel agency serving Bangladesh, UAE, and worldwide.",
  ...
  openGraph: {
    ...
    title:
      "Our Travel Services | Visa, Tours & Flights",

    description:
      "Discover complete travel solutions including visa processing, holiday packages, and flight booking services.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Travel services including visa tours flights and packages",
      },
    ],
  },
  ...
  twitter: {
    ...
    title:
      "Travel Services | Eammu Holidays",
    description:
      "Visa services, tour packages, flights, and more.",
