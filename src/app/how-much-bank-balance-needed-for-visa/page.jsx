...
export const metadata = {
  ...
  alternates: { canonical: "https://eammu.com/how-much-bank-balance-needed-for-visa" },
  robots: { index: true, follow: true, googleBot: { index: true, follow: true, "max-image-preview": "large", "max-snippet": -1 } },
  openGraph: {
    type: "article",
    url: "https://eammu.com/how-much-bank-balance-needed-for-visa",
    ...
    images: [{ url: "https://eammu.com/preview-banner.webp", width: 1200, height: 630, alt: "How Much Bank Balance for Visa — Eammu Holidays" }],
  },
  twitter: { card: "summary_large_image", site: "@eammuholidays", title: "How Much Bank Balance Is Needed for Visa 2026? | Eammu Holidays", images: ["https://eammu.com/preview-banner.webp"] },
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://eammu.com/how-much-bank-balance-needed-for-visa#article",
      ...
      mainEntityOfPage: "https://eammu.com/how-much-bank-balance-needed-for-visa",
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "How Much Bank Balance for Visa", item: "https://eammu.com/how-much-bank-balance-needed-for-visa" },
      ],
    },
  ],
};
  ...
  return (
    <>
      ...
      <div className="sr-only" aria-hidden="true">
        ...
        <nav aria-label="Breadcrumb"><ol><li><a href="https://eammu.com">Home</a></li><li><a href="https://eammu.com/travel-resources">Travel Resources</a></li><li><a href="https://eammu.com/how-much-bank-balance-needed-for-visa">How Much Bank Balance for Visa</a></li></ol></nav>
      </div>
