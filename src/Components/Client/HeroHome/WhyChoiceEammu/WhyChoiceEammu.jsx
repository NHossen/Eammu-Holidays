...
const WhyChoiceEammu = () => {
  ...
  const values = [
    ...
    { id: "customer", title: "Focus On Customer", icon: "✅", text: "Eammu Holidays is leading tour operator of Bangladesh. Eammu Holidays is established in 2012 with a view to develop sustainable tours to various destinations in this beautiful Bangladesh and as such you can meet the generous peoples of this country. Our team is committed to give you a new light of tourism experiences which you had never before." },
