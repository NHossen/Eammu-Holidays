...
const SpecialOffers = () => {
  ...
  // ✅ auto-scroll with null guard and pause support
  useEffect(() => {
      ...
      >
        ...
        >
          {filteredData.length > 0 ? filteredData.map((item, i) => (
            ...
            >
              {/* ✅ Next.js Image — WebP, srcset, lazy loading, no layout shift */}
              <Link
                href={item.link}
              ...
              >
                <Image
                  ...
                  // ✅ first 2 visible on desktop eager, rest lazy
        ...
        {filteredData.length > 1 && (
          <>
            <button
              ...
              onClick={() => scroll('left')}
              className="absolute -left-4 top-1/2 -translate-y-1/2 z-10 bg-white p-2 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition hidden lg:block border border-gray-100"
            >
            ...
            <button
              ...
              className="absolute -right-4 top-1/2 -translate-y-1/2 z-10 bg-white p-2 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition hidden lg:block border border-gray-100"
            >
