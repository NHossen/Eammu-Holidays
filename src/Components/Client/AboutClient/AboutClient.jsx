...
export default function AboutClient({ heroSlides = [], stats = [], services = [], faqs = [] }) {
  ...
  return (
    <main className="overflow-hidden">
      {/* Hero Section - FIXED PADDING LOGIC */}
      <section className="relative min-h-[50vh] flex items-center justify-center py-24 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/10 via-black/20 to-black/30 z-10"></div>
            </motion.div>
          </AnimatePresence>
        </div>

        {/* Content Layer (Relative) - This now respects the py-24 padding */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-32 py-18">
