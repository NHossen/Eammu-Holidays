"use client";
// components/ScholarshipsClient.jsx  ← CLIENT COMPONENT
// Receives all data as props from the Server Component.
// Owns: search state, live dropdown, pagination.
...
export default function ScholarshipsClient({
  ...
  const indexOfFirst      = (currentPage - 1) * COUNTRIES_PER_PAGE;
  const currentCountries  = filteredCountries.slice(indexOfFirst, indexOfFirst + COUNTRIES_PER_PAGE);
  ...
  const scrollToGrid = () => window.scrollTo({ top: 400, behavior: 'smooth' });
      ...
      <div className="bg-white border-b border-gray-100 pt-20 pb-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <nav
            ...
            className="flex justify-center gap-2 text-[10px] text-gray-400 mb-8 uppercase tracking-widest font-bold"
          >
          ...
          <p className="text-gray-500 max-w-xl mx-auto mb-6 text-lg font-medium">{subtitle}</p>
          ...
          <div className="relative max-w-2xl mx-auto mb-10" ref={searchRef}>
            ...
            >
              ...
              <Link
                href={
                  searchResults[0]
                    ? `/scholarships/${slug(searchResults[0].country)}`
                    : '/scholarships'
                }
            ...
            {featuredCodes.map((code) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <span className="text-sm font-black text-gray-600 group-hover:text-blue-600">
                    {country.country}
                  </span>
                </Link>
              );
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {stats.map((s, i) => (
              <div
                key={i}
                className="bg-gray-50 rounded-2xl px-6 py-5 group cursor-default hover:bg-blue-50 transition-all"
              >
        ...
        <div className="flex items-end justify-between mb-6">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1 font-medium">
              Jump directly to the world's most competitive fully funded programs.
            </p>
          </div>
          <Link
            href="/scholarships"
            className="hidden md:block text-xs font-black text-blue-600 hover:underline uppercase tracking-wider"
          >
            View All →
          </Link>
        </div>
          ...
          {popularScholarships.map((s) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="font-black text-gray-900 text-sm truncate group-hover:text-blue-600 transition">
                  {s.name}
                </p>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-14">
        <div className="flex items-end justify-between mb-8 border-b border-gray-100 pb-6">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1 font-medium">
              Browse our full database of global educational funding for 2026.
            </p>
          </div>
              ...
              <div className="flex gap-2">
                {[...Array(totalPages)].map((_, i) => {
                  ...
                  if (
                      ...
                      <button
                        ...
                        className={`w-12 h-12 rounded-xl font-black transition-all duration-300 ${
                          currentPage === pageNum
                            ...
                            : 'bg-white border border-gray-100 text-gray-400 hover:text-blue-600'
                        }`}
                      >
                        {pageNum}
                      </button>
                    ...
                    return (
                      <span key={i} className="flex items-center text-gray-300 px-1">
                        ...
                      </span>
                    );
                  }
      ...
      <div className="max-w-7xl mx-auto px-6 mt-20">
        <div className="grid md:grid-cols-3 gap-6">
          {seoTextBlocks.map((block, i) => (
            <div
              key={i}
              className="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm hover:shadow-xl hover:shadow-blue-50 transition-all"
            >
      ...
      <div className="max-w-4xl mx-auto px-6 mt-20">
        ...
        <div className="space-y-3">
          {faqItems.map((item, i) => (
            <details
              key={i}
              className="group bg-white border border-gray-100 rounded-2xl p-6 shadow-sm cursor-pointer"
            >
              <summary className="font-black text-gray-900 text-base list-none flex justify-between items-center">
                {item.q}
                <span className="text-blue-600 text-xl group-open:rotate-45 transition-transform duration-200 flex-shrink-0 ml-4">
                  +
                </span>
              </summary>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16">
        <div className="bg-gray-900 rounded-[2.5rem] p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <p className="text-[10px] uppercase font-black text-blue-400 tracking-[0.3em] mb-3">
              Start Your Journey
            </p>
            ...
            <p className="text-gray-400 max-w-md mx-auto mb-8 text-sm">
              Many programs close in October–December. Choose a country to see open scholarships now.
            </p>
