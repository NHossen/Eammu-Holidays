...
// ── SEO POPULAR ROUTES (high search volume) ──────────────────────────────
...
// ── VISA CATEGORIES ──────────────────────────────────────────────────────
const VISA_TYPES = [
  { icon: '🏖️', label: 'Tourist', desc: 'Leisure & sightseeing visits' },
  { icon: '💼', label: 'Business', desc: 'Meetings, conferences, trade' },
  { icon: '🎓', label: 'Student', desc: 'Academic enrollment abroad' },
  { icon: '👨‍👩‍👧', label: 'Family', desc: 'Reunification & sponsorship' },
  { icon: '💊', label: 'Medical', desc: 'Treatment & health tourism' },
  { icon: '🧳', label: 'Transit', desc: 'Layover & onward travel' },
];
      ...
      >
        ...
        <motion.div variants={itemVars} className="text-center mb-14">
          ...
          <p className="text-slate-500 text-lg max-w-2xl mx-auto leading-relaxed mb-3">
            Get complete, embassy-accurate visa requirements, mandatory documents, processing times, 
            and fees — for every country, every nationality.
          </p>
          <p className="text-slate-400 text-sm font-medium">
            Trusted by <strong className="text-slate-600">42,000+ travelers</strong> · Updated monthly for 2026 protocols
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white/80 backdrop-blur-2xl p-4 md:p-6 rounded-[2.5rem] shadow-[0_32px_100px_-20px_rgba(59,130,246,0.12)] border border-white/80">
            ...
            <p className="text-center text-xs font-black uppercase tracking-widest text-slate-400 mb-6">
              Select your nationality & destination to get your personalized visa guide
            </p>
        ...
        <motion.div variants={itemVars} className="mb-16">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">Based on real monthly search volume — updated weekly</p>
            </div>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-1">
                    {origEntry?.flag && <img src={origEntry.flag} className="w-7 h-4.5 object-cover rounded shadow-sm" alt="" />}
                    <span className="text-xs text-slate-400 font-bold">→</span>
                    {destEntry?.flag && <img src={destEntry.flag} className="w-7 h-4.5 object-cover rounded shadow-sm" alt="" />}
                    <div className="ml-1">
                      <div className="text-sm font-black text-slate-800">{r.origin} → {r.dest}</div>
                      <div className="text-[10px] text-slate-400 font-semibold">Tourist · Sticker Visa · 15–21 days</div>
                    </div>
                  </div>
        ...
        <motion.div variants={itemVars} className="mb-16">
          <div className="flex items-center gap-4 mb-6">
            <h2 className="text-2xl font-black tracking-tight shrink-0">All Destinations for {origin.charAt(0).toUpperCase() + origin.slice(1)} Citizens</h2>
        ...
        <motion.div
          variants={itemVars}
          className="grid md:grid-cols-3 gap-8 border-t border-slate-100 pt-16"
        >
          {[
            {
              icon: '📡',
              title: 'Live 2026 Data',
              desc: 'Embassy requirements refreshed monthly. We track policy changes across 195+ countries so your application is never rejected for outdated info.',
            },
            {
              icon: '🛡️',
        ...
        <motion.div variants={itemVars} className="mt-16 bg-white rounded-[2rem] border border-slate-100 p-8 md:p-12">
          <h2 className="text-2xl font-black text-slate-900 mb-4">Complete Visa Guide for Bangladeshi Travelers — 2026</h2>
          <div className="grid md:grid-cols-2 gap-8 text-sm text-slate-500 leading-relaxed">
            <div className="space-y-4">
              <p>
                Navigating international visa requirements can be overwhelming — different embassies, different rules, 
                constantly changing policies. Eammu Holidays' Visa Intelligence Portal gives Bangladeshi travelers 
                instant access to accurate, embassy-verified requirements for every destination worldwide.
              </p>
              <p>
                Whether you're applying for a <strong className="text-slate-700">Canada tourist visa</strong>, 
                a <strong className="text-slate-700">UK Standard Visitor Visa</strong>, or a 
                <strong className="text-slate-700"> Schengen multi-entry visa</strong>, our guides cover 
                mandatory documents, photo specifications, bank statement requirements, NOC formats, 
                and step-by-step processing timelines.
              </p>
            </div>
            <div className="space-y-4">
              <p>
                Our team of certified visa consultants monitors embassy circulars, 
                VFS Global announcements, and consulate policy updates to ensure every 
                guide reflects current 2026 protocols — not outdated information that could get your 
                application rejected.
              </p>
              <p>
                From <strong className="text-slate-700">financial documentation</strong> (6-month bank statements, 
                solvency certificates, IT returns) to <strong className="text-slate-700">travel logistics</strong> 
                (flight reservations, hotel bookings, detailed itineraries), we tell you exactly what to prepare 
                so your application is complete, accurate, and compelling.
              </p>
            </div>
          </div>
        </motion.div>
