            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-16">
                    ...
                    <nav className="flex flex-col space-y-3" aria-label="Eammu Group companies">
                        ...
                        <Link href="/" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                            Eammu Holidays
                        </Link>
                        <Link href="/web-development-digital-marketing" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                            Eammu IT & Marketing
                        </Link>
                        <Link href="/event-management" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                            Eammu Event Management
                        </Link>
                        <Link href="/eammu-dairy-poultry" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                            Eammu Dairy & Poultry
                        </Link>
                        <Link href="/eammu-fashion" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                            Eammu Fashion
                        </Link>
                        <Link href="/eammu-textile-bangladesh" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                    ...
                    <nav className="flex flex-col space-y-3" aria-label="Useful links">
                        ...
                        <Link href="/eammu-social-responsibility" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                            Social Responsibility
                        </Link>
                        <Link href="/news-feeds" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                            Newsfeeds
                        </Link>
                        <Link href="/our-leading-team" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                            Our Leading Team
                        </Link>
                        <Link href="/careers" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                            Careers
                        </Link>
                        <Link href="/terms-privacy-policy" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                            Privacy Policy
                        </Link>
                        <Link href="/travel-resources" className="text-[#696969] hover:text-[#005a31] transition-all text-[15px]">
                            Travel Resources
                        </Link>
                    </nav>
                    ...
                    <nav className="flex flex-col space-y-3" aria-label="Social media">
                        ...
                        <a
                            ...
                            className="text-blue-800 hover:underline text-[15px]"
                        >
                            LinkedIn
                        </a>
                        <a
                            ...
                            className="text-pink-700 hover:underline text-[15px]"
                        >
                            Instagram
                        </a>
                    </nav>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="join w-full border border-gray-200 rounded-lg overflow-hidden">
                                ...
                                />
                                <button className="btn bg-[#005a31] text-white border-none join-item px-4 h-12">
                                    Go
                                </button>
                            </div>
                        </div>
