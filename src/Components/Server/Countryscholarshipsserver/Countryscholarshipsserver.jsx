// app/scholarships/[slug]/CountryScholarshipsServer.jsx  ← SERVER COMPONENT
// Renders static structure, SEO content, and scholarship listings.
// Interactive parts (FAQ accordion, random intro) are delegated to client sub-components.

import FaqSection from "@/Components/Client/CountryScholarshipsClient/FaqSection";
import RandomIntro from "@/Components/Client/CountryScholarshipsClient/Randomintro";
...
export default function CountryScholarshipsServer({
  slug,
  initialScholarships,
  initialCountryInfo,
  allCountries,
    ...
    return (
      <div className="min-h-screen bg-[#F0F4FF] pb-20">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          {/* FAQ — client component (accordion needs useState) */}
          <FaqSection
            items={[
              {
          ...
          {/* Nearby countries */}
          <h3 className="text-2xl font-black text-gray-900 mb-6 mt-16">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-8 pb-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-8">
            ...
            <div className="flex-1">
              ...
              {/* Random intro — client component (needs Math.random on mount) */}
              <RandomIntro
                intros={dynamicIntros.map((fn) => fn(countryName, scholarships.length))}
              />
            </div>
...
// ─── Pure UI Sub-components (no state — safe in server component) ─────────────
