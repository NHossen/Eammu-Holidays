      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-emerald-50 text-[#005a31] px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-emerald-100">
                <ShieldCheck size={14} /> 2026 Balkan Specialist
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                Serbia Visa <br /> 
                <span className="text-[#ff6b00]">The Heart of Balkans.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Expert assistance for **Type C Tourist & Business visas**. We specialize in navigating the 2026 requirements for the Embassy of Serbia in Abu Dhabi, ensuring your invitation letters and bank statements are embassy-ready.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-[8px] border-white ring-1 ring-slate-100">
                <img 
                  src="https://images.unsplash.com/photo-1563294329-37332219199d?q=80&w=1200" 
                  alt="Belgrade Fortress, Serbia" 
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl border border-slate-50 hidden md:block">
                <p className="text-[#005a31] font-black text-3xl">15-21</p>
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="Processing Time" value="15-21 Working Days" />
            <MetricBox icon={<Wallet />} label="Consular Fee" value="~90 EUR (AED 385)" />
            <MetricBox icon={<TrendingUp />} label="Approval Rate" value="High with Vouchers" />
            <MetricBox icon={<Globe />} label="Waiver Status" value="Schengen/US/UK Holders" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">Serbia Travel Tips</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="Entry Waiver 2026" desc="How to enter Serbia using your valid US or Schengen visa." />
              <VideoCard id="mVo9V7RR5fE" title="Certified Invitations" desc="Understanding the 'Original Copy' requirement for private visits." />
              <VideoCard id="NrSjr1GnotY" title="Belgrade Nightlife Guide" desc="Why 2026 is the best year to visit the 'White City'." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-[#005a31] mb-12 uppercase tracking-tighter">
              Visa <span className="text-[#ff6b00]">Services</span>
            </h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                img="https://images.unsplash.com/photo-1552554650-097063d917f3?q=80&w=800" 
                type="Type C" 
                title="Tourist Voucher" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1578328819058-b69f3a3b0f6b?q=80&w=800" 
                type="Type C" 
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">Short-Stay (Type C) Requirements - 2026</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="3.5 x 4.5 cm Photo (White)" />
                  </div>
                </div>
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Original Stamped Bank Stmt (3M)" />
                    <CheckItem text="NOC with Salary & Position" />
                    <CheckItem text="Trade License (if Applicable)" />
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Travel Medical Insurance (€20k+)" />
                    <CheckItem text="Pre-paid Tourist Voucher" />
                    <CheckItem text="Round Trip Flight Reservation" />
                    <CheckItem text="Daily Activity Plan" />
                  </div>
                </div>

                {/* 4. VISA WAIVER EXEMPTION BOX */}
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Entry Waiver Eligibility 2026</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="Valid Multiple Schengen Visa" />
                      <CheckItem light text="Schengen Residence Permit" />
                      <CheckItem light text="Valid US or UK Visa" />
                      <CheckItem light text="Stay Up to 90 Days Free" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    <strong className="text-[#005a31] font-black uppercase text-sm block mb-1">Critical Requirement:</strong> 
                    For tourism, a standard hotel reservation is often insufficient. The Serbian Embassy in Abu Dhabi strictly 
                    requires a **Pre-paid Tourist Voucher** issued by a licensed travel agency or a **Certified Invitation Letter** authenticated by the local municipality in Serbia. We provide the necessary agency-vetted vouchers to 
                    ensure your application meets the 2026 submission standards.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">Proof of Funds Standards</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">To avoid rejection, your financial profile must meet the Serbian Consular minimums:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Minimum of €50 (approx. AED 210) per day of stay must be visible.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Bank statements must be physical original copies with a wet stamp.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Personal salary transfers should be clearly identifiable in the transactions.</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">Balkan Travel Protocol 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  q="Does a UAE Residence permit allow visa-free entry?" 
                  a="No. UAE residency alone is not enough. You must either hold a passport from a visa-exempt country or have a valid multiple-entry Schengen, US, or UK visa." 
                />
                <FAQBox 
                  q="Is Serbia part of the Schengen Zone?" 
                  a="No. Serbia is an EU candidate country but not yet in Schengen. However, they recognize Schengen visas for entry purposes." 
                />
                <FAQBox 
                  q="How much is the total cost including agency fees?" 
                  a="The consular fee is ~AED 385. Our service fees vary based on document assistance (vouchers/translations). Contact us on WhatsApp for a full 2026 quote." 
                />
                <FAQBox 
                  q="Do I have to register with the police in Serbia?" 
                  a="Yes. Foreigners must register their stay with the local police within 24 hours of arrival. If you stay in a hotel, they will handle this for you (Beli Karton)." 
                />
                <FAQBox 
                  q="Can I apply if my passport is older than 10 years?" 
                  a="No. Even if valid, your passport must have been issued within the last 10 years. This is a strict Serbian Ministry requirement." 
                />
                <FAQBox 
                  q="How far in advance should I submit my file?" 
                  a="We recommend applying at least 4-5 weeks before travel. Appointments at the Abu Dhabi Embassy can be limited during peak summer and winter seasons." 
                />
              </div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-4 lg:sticky lg:top-8 self-start">
            ...
            <div className="mt-10 bg-[#f8fafc] border border-slate-100 rounded-[3rem] p-12 text-center flex flex-col items-center">
               ...
               <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.25em] mb-2">BALKAN MISSION SERVICES</p>
