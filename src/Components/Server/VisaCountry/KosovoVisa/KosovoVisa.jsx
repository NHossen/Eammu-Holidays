      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-emerald-50 text-[#005a31] px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-emerald-100">
                <ShieldCheck size={14} /> Balkan Travel Expert 2026
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                Kosovo Visa <br /> 
                <span className="text-[#ff6b00]">Europe's Newest Soul.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Comprehensive support for **Type C (Short-stay)** visas. Whether you're visiting Pristina for tourism or Prizren for business, we ensure your 2026 documentation meets the strict requirements of the Ministry of Foreign Affairs.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-[8px] border-white ring-1 ring-slate-100">
                <img 
                  src="https://images.unsplash.com/photo-1590435163152-4740e6988225?q=80&w=1200" 
                  alt="Pristina, Kosovo" 
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="Processing Time" value="10-15 Days" />
            <MetricBox icon={<Wallet />} label="Consular Fee" value="40 EUR (~AED 165)" />
            <MetricBox icon={<TrendingUp />} label="Stay Limit" value="90 Days" />
            <MetricBox icon={<Globe />} label="Schengen Holders" value="Visa-Free Entry" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">Kosovo Travel Insights</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="Entry Rules 2026" desc="Latest updates on biometric residency and entry permits." />
              <VideoCard id="mVo9V7RR5fE" title="Balkan Multi-Trip" desc="Using Kosovo as a gateway to Albania and Montenegro." />
              <VideoCard id="NrSjr1GnotY" title="Business in Pristina" desc="Invitation letter requirements for foreign entrepreneurs." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                img="https://images.unsplash.com/photo-1549488344-cbb6c34cf08b?q=80&w=800" 
                type="Type C" 
                title="Tourist Visit" 
              />
              <PosterCard 
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="ICAO Standard Photo (x1)" />
                  </div>
                </div>
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="3-Month Stamped Bank Stmt" />
                    <CheckItem text="Proof of Social Ties (UAE)" />
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Health Insurance (Kosovo Valid)" />
                    <CheckItem text="Hotel Voucher/Reservation" />
                    <CheckItem text="Round Trip Flight Ticket" />
                    <CheckItem text="Purpose of Stay Letter" />
                  </div>
                </div>

                {/* 4. SCHENGEN EXEMPTION BOX */}
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Visa-Free Eligibility 2026</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="Valid Multi-Schengen Visa" />
                      <CheckItem light text="Schengen Resident Permit" />
                      <CheckItem light text="US/Canada Multi-Visa" />
                      <CheckItem light text="EU Passport Holders" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    <strong className="text-[#005a31] font-black uppercase text-sm block mb-1">Important 2026 Notice:</strong> 
                    While Kosovo recently achieved visa liberalization with the EU, this applies to Kosovar citizens. 
                    For **UAE Residents** with third-party passports (e.g., India, Pakistan, Philippines), you must apply for 
                    a Type C visa unless you hold a **valid multiple-entry Schengen visa**. All documents must be submitted 
                    in **duplicate (two copies)** and translated into English or one of Kosovo's official languages.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">Health Insurance Standards</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">Kosovo authorities require specific travel health insurance for all short-stay applicants:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Must cover the entire duration of stay in the territory.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Minimum coverage of €30,000 (approx. AED 120,000).</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Must include emergency repatriation and hospital treatment.</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">Balkan Entry Protocol 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  q="Do I need a Kosovo visa if I have a Schengen visa?" 
                  a="If you have a valid multiple-entry Schengen visa, you are exempt from a Kosovo visa for stays up to 15 days within a 6-month period." 
                />
                <FAQBox 
                  q="What is the visa fee for children?" 
                  a="The standard fee for a Type C visa is 40 EUR. Children under 6 years of age are typically exempt from this fee." 
                />
                <FAQBox 
                  q="How far in advance should I apply?" 
                  a="You must submit your application in person at least 15 days—but no more than 3 months—before your intended travel date." 
                />
                <FAQBox 
                  q="Are E-vistas available for Kosovo?" 
                  a="As of 2026, most short-stay applications still require physical submission at the nearest Diplomatic or Consular Mission. We manage the scheduling and document verification for you." 
                />
                <FAQBox 
                  q="Does the bank statement need a stamp?" 
                  a="Yes, the original 3-month bank statement must have a physical wet stamp from your bank in the UAE." 
                />
                <FAQBox 
                  q="Can I travel to Serbia from Kosovo?" 
                  a="Entry into Serbia from Kosovo can be complex if you did not originally enter Kosovo via Serbia. We recommend entering the region through a Serbian border first if you plan to visit both." 
                />
              </div>
            </section>
          </div>
