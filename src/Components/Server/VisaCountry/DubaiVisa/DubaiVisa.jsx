      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-emerald-50 text-[#005a31] px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-emerald-100">
                <ShieldCheck size={14} /> GDRFA & ICP Partner 2026
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                Dubai Visa <br /> 
                <span className="text-[#ff6b00]">The City of Gold.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Premier agency for **30 & 60-Day Tourist Visas**, **5-Year Multi-Entry Permits**, and **Golden Visa** consultations. Fast-track processing for all nationalities with 24-hour express options.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl border border-slate-50 hidden md:block">
                <p className="text-[#005a31] font-black text-3xl">24h</p>
                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Express Service</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="Normal Processing" value="48-72 Hours" />
            <MetricBox icon={<Wallet />} label="30-Day Visa" value="From AED 350*" />
            <MetricBox icon={<TrendingUp />} label="Extension" value="Inside Country" />
            <MetricBox icon={<Globe />} label="E-Visa" value="Paperless Entry" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">UAE Visa Guides</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="30 vs 60 Day Visas" desc="Which one is better for your 2026 Dubai trip?" />
              <VideoCard id="mVo9V7RR5fE" title="Indian Passport VOA" desc="Rules for US/UK/Schengen visa holders at DXB." />
              <VideoCard id="NrSjr1GnotY" title="Golden Visa 2026" desc="New categories for professionals and property owners." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-[#005a31] mb-12 uppercase tracking-tighter">
              Visa <span className="text-[#ff6b00]">Packages</span>
            </h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                img="https://images.unsplash.com/photo-1546412414-e188526159ca?q=80&w=800" 
                type="Tourist" 
                title="30 Days Single" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1582672060674-bc2bd808a8b5?q=80&w=800" 
                type="Tourist" 
                title="60 Days Single" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1518684079-3c830dcef090?q=80&w=800" 
                type="Business" 
                title="Multi-Entry" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1578894567939-2429467ace6d?q=80&w=800" 
                type="Residency" 
                title="Golden Visa" 
              />
            </div>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h2 className="text-4xl font-black uppercase tracking-tight">Application Checklist</h2>
                    <p className="text-slate-500 font-medium mt-1">Simple paperless documentation for 2026</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Passport Scan (Color)" />
                    <CheckItem text="Bio Page & Last Page" />
                    <CheckItem text="White Background Photo" />
                    <CheckItem text="6 Months Validity" />
                  </div>
                </div>
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="UAE Travel Insurance" />
                    <CheckItem text="Confirmed Return Ticket" />
                    <CheckItem text="Hotel Booking / Address" />
                    <CheckItem text="Smart Pass QR (New)" />
                  </div>
                </div>

                {/* 3. SPECIAL NATIONALITIES */}
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Criteria B</h4>
                  <div className="space-y-4">
                    <CheckItem text="Guarantor Docs (Optional)" />
                    <CheckItem text="Bank Statement (If Needed)" />
                    <CheckItem text="Birth Certificate (Minors)" />
                    <CheckItem text="NOC for solo travelers" />
                  </div>
                </div>

                {/* 4. GOLDEN VISA & 5-YEAR MULTI */}
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Premium Residency Routes</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="AED 4,000+ Bank Balance" />
                      <CheckItem light text="Property Investment Proof" />
                      <CheckItem light text="Professional Degree Attested" />
                      <CheckItem light text="5-Year Validity Term" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    ...
                    Dubai has simplified the stay options. The **60-day visa** is now the standard for longer visits. If you are an 
                    Indian citizen with a valid **US Green Card, UK/Schengen Visa**, you are eligible for **Visa on Arrival** at any 
                    UAE airport. We can assist with the mandatory pre-entry fee processing to save you time at the counter.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">Overstay Regulations</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">UAE authorities have strictly standardized overstay fines in 2026:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>AED 50 per day for overstaying your tourist visa.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Status changes must be initiated at least 3 days before expiry to avoid penalties.</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">Dubai Visa Protocol 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  q="Can I extend my tourist visa without leaving Dubai?" 
                  a="Yes, we can process an 'In-Country' extension for 30 additional days. This includes the status change fee and does not require you to exit through the airport." 
                />
                <FAQBox 
                  q="What is the 5-Year Multi-Entry Visa?" 
                  a="It allows you to enter and exit the UAE as many times as you like for 5 years. You can stay for 90 days per visit (extendable to 180). Requires USD 4,000 bank balance proof." 
                />
                <FAQBox 
                  q="Do kids need a separate visa?" 
                  a="Yes, every traveler including infants needs their own visa. However, during summer months, the UAE often runs 'Kids Go Free' promotions where visa fees for children are waived." 
                />
                <FAQBox 
                  q="How long does the 30-day visa take?" 
                  a="Standard processing is 48-72 hours. We also offer Express Processing (6-12 hours) for urgent travelers at an additional cost." 
                />
                <FAQBox 
                  q="Is health insurance included in the price?" 
                  a="Yes, all our visa packages include mandatory UAE-compliant COVID-19 and health coverage required by immigration." 
                />
                <FAQBox 
                  q="What is the 'A2A' Visa Change?" 
                  a="A2A (Airport to Airport) is a same-day visa renewal where you fly to a neighboring country (like Oman) and return immediately on a new visa." 
                />
              </div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-4 lg:sticky lg:top-8 self-start">
            ...
            <div className="mt-10 bg-[#f8fafc] border border-slate-100 rounded-[3rem] p-12 text-center flex flex-col items-center">
               ...
               <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.25em] mb-2">GOVERNMENT SERVICES</p>
