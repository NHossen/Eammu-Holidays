      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                Georgia Visa <br /> 
                <span className="text-[#ff6b00]">The Pearl of Caucasus.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Expert assistance for **UAE Residents** traveling to Georgia. Enjoy **90-day visa-free entry** or secure a fast-track **E-Visa** with our 2026-compliant insurance and documentation support.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-[8px] border-white ring-1 ring-slate-100">
                <img 
                  src="https://images.unsplash.com/photo-1565008447742-97f6f38c985c?q=80&w=1200" 
                  alt="Tbilisi, Georgia Skyline" 
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl border border-slate-50 hidden md:block">
                ...
                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Entry Guarantee*</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="E-Visa Processing" value="5 Working Days" />
            <MetricBox icon={<Wallet />} label="Official Fee" value="USD $20 + Service" />
            <MetricBox icon={<TrendingUp />} label="UAE Residents" value="90 Days Visa-Free" />
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">Georgia Entry Guide</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="UAE Resident Privileges" desc="How to enter Georgia using your Emirates ID in 2026." />
              <VideoCard id="mVo9V7RR5fE" title="New Insurance Rules" desc="Understanding the mandatory 30,000 GEL health coverage." />
              <VideoCard id="NrSjr1GnotY" title="E-Visa Portal Walkthrough" desc="Step-by-step digital application for non-residents." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-[#005a31] mb-12 uppercase tracking-tighter">
              Georgia <span className="text-[#ff6b00]">Entry Types</span>
            </h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                img="https://images.unsplash.com/photo-1523585422575-0165780f274a?q=80&w=800" 
                type="Exempt" 
                title="UAE Resident Entry" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1601058268499-e526584ee228?q=80&w=800" 
                type="Electronic" 
                title="C1 Tourist E-Visa" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1565967511849-76a60a516170?q=80&w=800" 
                type="Investment" 
                title="D5 Property Visa" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1549944850-84e00be4203b?q=80&w=800" 
                type="Long Term" 
                title="D1 Work/Business" 
              />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h2 className="text-4xl font-black uppercase tracking-tight">Georgia Checklist</h2>
                    <p className="text-slate-500 font-medium mt-1">Required for Airport Immigration & E-Visa</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="Original Emirates ID card" />
                    <CheckItem text="UAE Residence Visa Scan" />
                    <CheckItem text="Digital Photo (E-Visa)" />
                  </div>
                </div>

                {/* 2. MANDATORY 2026 RULES */}
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Mandatory 2026</h4>
                  <div className="space-y-4">
                    <CheckItem text="Health Insurance (30k GEL)" />
                    <CheckItem text="Accident Insurance Coverage" />
                    <CheckItem text="English/Georgian Policy" />
                    <CheckItem text="Insurance Validity for stay" />
                  </div>
                </div>

                {/* 3. TRAVEL PROOF */}
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Support Docs</h4>
                  <div className="space-y-4">
                    <CheckItem text="Return Flight Ticket" />
                    <CheckItem text="Hotel/Airbnb Booking" />
                    <CheckItem text="3 Months Bank Statement" />
                    <CheckItem text="Proof of Funds (Cash/Card)" />
                  </div>
                </div>
                ...
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Visa-Free Eligibility (UAE Residents)</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="Applies to ALL Nationalities" />
                      <CheckItem light text="90 Days in 180-Day Period" />
                      <CheckItem light text="Must have Valid Emirates ID" />
                      <CheckItem light text="Passport Valid for 90+ Days" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    ...
                    As of January 1, 2026, all visitors (including visa-free UAE residents) **must** present valid health and accident 
                    insurance with a minimum coverage of **30,000 Georgian Lari** (approx. AED 41,000). Failure to present this at the 
                    border will result in denied entry. We provide instant policy issuance that meets this exact requirement.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">When do you need an E-Visa?</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">While most UAE residents are exempt, you must apply for an E-Visa if:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>You are traveling from outside the UAE and do not have a valid residency.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Your UAE Residence Permit has less than 1 year of validity (for specific nationalities).</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">Georgia Entry Protocol 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  q="Do Indians/Pakistanis in UAE need a visa for Georgia?" 
                  a="No. If you hold a valid UAE Residence Visa/Emirates ID, you can enter Georgia visa-free for 90 days. You only need your Passport, Emirates ID, Insurance, and Flight/Hotel bookings." 
                />
                <FAQBox 
                  q="What is the mandatory insurance amount?" 
                  a="The policy must cover at least 30,000 Georgian Lari for health and accident expenses. It must be in English or Georgian and valid for your entire stay." 
                />
                <FAQBox 
                  q="Is there a visa on arrival for Georgia?" 
                  a="No, Georgia does not have a VOA system. You are either Visa-Exempt (like UAE residents) or you must apply for an E-Visa before you fly." 
                />
                <FAQBox 
                  q="How long can I stay in Georgia?" 
                  a="UAE residents can stay for 90 days within any 180-day period. UAE Citizens (Passport holders) can stay for up to one full year visa-free." 
                />
                <FAQBox 
                  q="Do I need to carry a printed Emirates ID?" 
                  a="Yes, you must carry your physical, original Emirates ID card. Immigration officers will verify the validity of your residency at the border." 
                />
                <FAQBox 
                  q="Can I work in Georgia on a tourist entry?" 
                  a="No. To work or conduct business, you must apply for a Type D Immigration Visa through the Georgian Embassy or official portals." 
                />
              </div>
            </section>
          </div>
