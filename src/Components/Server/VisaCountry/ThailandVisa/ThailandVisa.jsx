      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-emerald-50 text-[#005a31] px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-emerald-100">
                <ShieldCheck size={14} /> Official 2026 E-Visa Partner
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                Thailand Visa <br /> 
                <span className="text-[#ff6b00]">Land of Smiles.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Streamlined **E-Visa** processing for 2026. From 60-day Tourist stays to the new **5-Year Destination Thailand Visa (DTV)**, we manage your TDAC registration and embassy submission with 100% digital accuracy.
              </p>
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="Processing Time" value="3-10 Working Days" />
            <MetricBox icon={<Wallet />} label="Tourist Fee" value="~AED 160 (Consular)" />
            <MetricBox icon={<TrendingUp />} label="Stay Limit" value="60-180 Days" />
            <MetricBox icon={<Globe />} label="E-Visa Format" value="100% Paperless" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">Thailand Travel 2026</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="TDAC Registration" desc="Step-by-step guide to the mandatory Digital Arrival Card." />
              <VideoCard id="mVo9V7RR5fE" title="The 5-Year DTV Visa" desc="How digital nomads can live in Thailand long-term in 2026." />
              <VideoCard id="NrSjr1GnotY" title="Bangkok to Phuket" desc="Internal travel rules and island entry requirements." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                img="https://images.unsplash.com/photo-1528181304800-2f5402924440?q=80&w=800" 
                type="Tourist" 
                title="60-Day Entry" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1501179691627-eeaa65ea017c?q=80&w=800" 
                type="DTV" 
                title="Digital Nomad" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1560264245-1dbfb9782b8b?q=80&w=800" 
                type="Activities" 
                title="Muay Thai / Medical" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1523240715632-d984bb4b990a?q=80&w=800" 
                type="Education" 
                title="ED Visa" 
              />
            </div>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">Required Digital Scans for 2026 E-Visa</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="Digital Photo (White B/G)" />
                  </div>
                </div>

                {/* 2. EMPLOYMENT & FINANCIALS */}
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Stability</h4>
                  <div className="space-y-4">
                    <CheckItem text="NOC from UAE Employer" />
                    <CheckItem text="3-Month Bank Statement" />
                    <CheckItem text="Min Balance AED 5k-10k" />
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="Completed TDAC Form" />
                    <CheckItem text="Vaccination Record (Digital)" />
                  </div>
                </div>

                {/* 4. DTV SPECIAL CATEGORY BOX */}
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Destination Thailand Visa (DTV) 2026</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="Proof of Remote Employment" />
                      <CheckItem light text="500,000 THB (~AED 52k) Balance" />
                      <CheckItem light text="5-Year Multiple Entry" />
                      <CheckItem light text="180-Day Stay per Entry" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    <strong className="text-[#005a31] font-black uppercase text-sm block mb-1">Mandatory 2026 Requirement:</strong> 
                    All travelers, including those from visa-exempt countries like the UAE, must complete the **Thailand Digital Arrival Card (TDAC)** before boarding. This digital registration has replaced the old paper TM6 card. Failure to show a QR code for your TDAC 
                    at the airport may result in boarding denial. We include TDAC assistance with every visa application.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">2026 Proof of Funds</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">The Royal Thai Consulate enforces strict financial scrutiny for Dubai/Abu Dhabi applicants:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Tourist Visa: Minimum AED 5,000 balance maintained for 30 days.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>DTV Visa: Exactly 500,000 THB (or AED equivalent) historical balance required.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Digital bank statements must show the account holder's name and address clearly.</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  q="Can I get a Visa on Arrival in Bangkok?" 
                  a="Yes, for certain nationalities (e.g., India, China), but it is limited to 15 days and requires long airport queues. Our 60-day E-Visa is recommended for longer stays." 
                />
                <FAQBox 
                  q="Do UAE Nationals need a visa for Thailand?" 
                  a="No. Emirati citizens are visa-exempt for stays up to 30 days. However, they MUST still complete the TDAC registration before travel." 
                />
                <FAQBox 
                  q="How long does the E-Visa process take?" 
                  a="Standard processing is 3-10 working days. There is no 'express' service at the consulate, so we advise applying at least 3 weeks before travel." 
                />
                <FAQBox 
                  q="Is health insurance still mandatory?" 
                  a="While not strictly mandatory for all tourist visas in 2026, it is highly recommended and required for DTV and Long-Stay (O-A) categories." 
                />
                <FAQBox 
                  q="Can I extend my stay while inside Thailand?" 
                  a="Yes, most 60-day tourist visas can be extended for an additional 30 days at a local immigration office in Thailand for a fee of 1,900 THB." 
                />
                <FAQBox 
                  q="What is the total fee including agency support?" 
                  a="Our service starts from AED 850, covering the E-Visa application, document scanning, and TDAC registration. Consular fees are paid separately." 
                />
              </div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-4 lg:sticky lg:top-8 self-start">
            ...
            <div className="mt-10 bg-[#f8fafc] border border-slate-100 rounded-[3rem] p-12 text-center flex flex-col items-center">
               ...
               <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.25em] mb-2">SOUTH EAST ASIA MISSION</p>
