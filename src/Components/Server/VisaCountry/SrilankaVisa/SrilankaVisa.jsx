...
import { 
  ...
  Instagram, Facebook, Menu, X, Waves
} from 'lucide-react';
...
const SrilankaVisa = () => {
  return (
    <>
      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-amber-100">
        
        {/* --- PREMIUM HERO SECTION --- */}
        <section className="relative pt-24 md:pt-32 pb-16 px-6 lg:px-12">
          {/* Soft Decorative Elements */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-amber-50 rounded-full blur-3xl -z-10 opacity-60" />
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-amber-50 text-[#005a31] px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-amber-100">
                <ShieldCheck size={14} /> 2026 REINSTATED ETA SYSTEM
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                Sri Lanka <br /> 
                <span className="text-[#ff6b00]">Pearl of Ocean.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Official **ETA (Electronic Travel Authorization)** processing for UAE residents. From the tea plantations of Ella to the beaches of Mirissa, we secure your entry permit in as little as 24 hours.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl border border-slate-50 hidden md:block">
                <p className="text-[#005a31] font-black text-3xl">24-72</p>
                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Hours Delivery*</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="ETA Speed" value="24 - 48 Hours" />
            <MetricBox icon={<Wallet />} label="Govt & Service" value="~AED 180 - 250" />
            <MetricBox icon={<TrendingUp />} label="Stay Period" value="30 Days (Double)" />
            <MetricBox icon={<Globe />} label="SAARC Rates" value="Reduced Fees Apply" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">Journey to Sri Lanka</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="ETA Portal Update 2026" desc="Understanding the return to the Electronic Travel Authorization system." />
              <VideoCard id="mVo9V7RR5fE" title="Colombo Airport Guide" desc="What to expect at BIA airport arrival and immigration in 2026." />
              <VideoCard id="NrSjr1GnotY" title="Kandy & Hill Country" desc="Travel requirements for exploring the cultural heart of the island." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-[#005a31] mb-12 uppercase tracking-tighter">
              Ceylon <span className="text-[#ff6b00]">Permits</span>
            </h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                img="https://images.unsplash.com/photo-1544450547-24a1937b5583?q=80&w=800" 
                type="Leisure" 
                title="Tourist ETA" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1586500036706-41963de24d8b?q=80&w=800" 
                type="Corporate" 
                title="Business ETA" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1552423814-c4783d81ad25?q=80&w=800" 
                type="Stopover" 
                title="Transit Permit" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1529733411124-640a43063533?q=80&w=800" 
                type="Medical" 
                title="Health Visit" 
              />
            </div>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
                <div className="flex items-center gap-5">
                  <div className="bg-[#005a31] p-4 rounded-[1.25rem] text-white shadow-xl shadow-amber-100">
                    <FileText size={32} />
                  </div>
                  <div>
                    <h2 className="text-4xl font-black uppercase tracking-tight">Visa Checklist</h2>
                    <p className="text-slate-500 font-medium mt-1">Sri Lanka ETA Requirements 2026</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                {/* 1. TRAVEL DOCUMENT */}
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-amber-200 transition-colors">
                  <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Identity</h4>
                  <div className="space-y-4">
                    <CheckItem text="Passport Copy (6M+ Valid)" />
                    <CheckItem text="UAE Residence Visa Copy" />
                    <CheckItem text="Digital Passport Photo" />
                ...
                {/* 2. STAY DETAILS */}
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-amber-200 transition-colors">
                  <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Stay Details</h4>
                  <div className="space-y-4">
                    <CheckItem text="Hotel Booking Info" />
                    <CheckItem text="Confirmed Return Flight" />
                    <CheckItem text="Approximate Travel Dates" />
                    <CheckItem text="Purpose of Visit" />
                  </div>
                </div>
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-amber-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="SL Company Invitation" />
                    <CheckItem text="UAE Company NOC" />
                    <CheckItem text="Business Contact Info" />
                ...
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">System Protocol 2026</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="Digital Approval Only" />
                      <CheckItem light text="Double Entry (30 Days)" />
                      <CheckItem light text="Valid via All Airports" />
                      <CheckItem light text="Extension at Colombo Dept" />
                    </div>
                  </div>
              ...
              {/* Pro Tip Box */}
              <div className="mt-10 p-8 bg-amber-50 border border-amber-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                <div className="bg-[#ff5722] text-white p-4 rounded-2xl shadow-lg shrink-0">
                  <ShieldCheck size={32} />
                </div>
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    <strong className="text-[#005a31] font-black uppercase text-sm block mb-1">2026 ETA Restoration:</strong> 
                    Sri Lanka has officially returned to the **Electronic Travel Authorization (ETA)** system after a period of portal changes. Travelers are strongly advised to obtain their ETA approval *before* departure. While a visa-on-arrival is technically possible at Colombo (BIA), it is limited to single-entry and often involves long queues. The ETA grants double-entry for 30 days.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">National Category Fees</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">ETA costs are determined by your passport nationality:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>**SAARC Countries:** (India, Pakistan, etc.) enjoy significantly lower government fees.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>**Non-SAARC:** Standard international rates apply for European, Arab, and Asian expats.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>**Free Visa Plans:** In 2026, certain nationalities may qualify for fee waivers under tourism initiatives. Check with us for updates.</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">Colombo Protocol 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  q="Do UAE Nationals need an ETA for Sri Lanka?" 
                  a="Yes. While often eligible for fee waivers or easy processing, UAE citizens must still register for an ETA prior to arrival." 
                />
                <FAQBox 
                  q="Can I extend my stay while in Sri Lanka?" 
                  a="Yes, the initial 30-day ETA can be extended for up to 270 days at the Department of Immigration & Emigration in Battaramulla, Colombo." 
                />
                <FAQBox 
                  q="Is the ETA valid for cruise ship arrivals?" 
                  a="Yes, the ETA is the official permit for all entry points, including international airports and designated seaports." 
                />
                <FAQBox 
                  q="What is the processing time via Eammu?" 
                  a="We typically deliver approved ETA notices via email or WhatsApp within 24 to 48 hours for standard applications." 
                />
                <FAQBox 
                  q="Do I need to submit my original passport?" 
                  a="No. Since it is an Electronic Travel Authorization, we only need a clear digital scan of your passport data page." 
                />
                <FAQBox 
                  q="Is a COVID-19 vaccination required in 2026?" 
                  a="As of 2026, health protocols have normalized. Vaccination certificates are generally not mandatory, but travel insurance is highly recommended." 
                />
              </div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-4 lg:sticky lg:top-8 self-start">
            ...
            <div className="mt-10 bg-[#f8fafc] border border-slate-100 rounded-[3rem] p-12 text-center flex flex-col items-center">
               ...
               <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.25em] mb-2">SRI LANKA MISSION SERVICES</p>
