      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-emerald-50 text-[#005a31] px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-emerald-100">
                <ShieldCheck size={14} /> AUTHORIZED E-VISA AGENT 2026
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                India Visa <br /> 
                <span className="text-[#ff6b00]">Incredible India.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Fast-track **e-Tourist**, **e-Business**, and **e-Medical** visas for 2026. We manage your official Indian Government portal submission and documentation for UAE residents and global travelers.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-[8px] border-white ring-1 ring-slate-100">
                <img 
                  src="https://images.unsplash.com/photo-1548013146-72479768bbaa?q=80&w=1200" 
                  alt="Taj Mahal, India" 
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="E-Visa Processing" value="1-3 Working Days" />
            <MetricBox icon={<Wallet />} label="Govt Fee (30D)" value="~AED 100 (Dependant)" />
            <MetricBox icon={<TrendingUp />} label="E-Visa Validity" value="30 Days to 5 Years" />
            <MetricBox icon={<Globe />} label="Entry Ports" value="31 Airports / 5 Seaports" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">India Travel Protocol</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="2026 E-Visa Guide" desc="Step-by-step on how to apply for the Indian ETA from Dubai." />
              <VideoCard id="mVo9V7RR5fE" title="Biometric Sticker Visa" desc="For nationalities requiring physical passport submission." />
              <VideoCard id="NrSjr1GnotY" title="Rajasthan Tourism" desc="Essential 2026 travel tips for luxury train journeys." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-[#005a31] mb-12 uppercase tracking-tighter">
              India <span className="text-[#ff6b00]">Visas</span>
            </h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                img="https://images.unsplash.com/photo-1524492707947-539659b96435?q=80&w=800" 
                type="e-Tourist" 
                title="1 Month / 1 Year" 
              />
              <PosterCard 
              ...
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1590766940554-634a7ed41450?q=80&w=800" 
                type="Special" 
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">Indian e-Visa Requirements 2026</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Passport Scan (Bio Page)" />
                    <CheckItem text="Min. 6 Months Validity" />
                    <CheckItem text="Recent Square Photo" />
                ...
                {/* 2. FAMILY & BACKGROUND */}
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Personal Details</h4>
                  <div className="space-y-4">
                    <CheckItem text="Parents' Birthplace Info" />
                    <CheckItem text="Marital Status Details" />
                    <CheckItem text="Home Address in UAE" />
                    <CheckItem text="Previous Indian Visa Info" />
                  </div>
                </div>
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="Hotel Address in India" />
                    <CheckItem text="Inviter Details (Business)" />
                    <CheckItem text="Entry/Exit Port Name" />
                  </div>
                </div>
                ...
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">India Immigration Protocol 2026</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="Printed ETA (E-Visa) PDF" />
                      <CheckItem light text="Biometrics at Airport" />
                      <CheckItem light text="Valid Boarding Pass" />
                      <CheckItem light text="Hotel Contact Info" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    <strong className="text-[#005a31] font-black uppercase text-sm block mb-1">E-Visa Photo Warning:</strong> 
                    The Indian Government portal uses high-precision AI for face matching. Your digital photo must be a perfect **Square (1:1 aspect ratio)** with a white background and no shadows. Scanned passport photos or low-resolution selfies are automatically rejected. We provide professional photo resizing to ensure 2026 compliance.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">2026 Validity Options</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">India offers several e-Tourist durations for UAE residents:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>**30-Day e-Tourist:** Double entry, valid from date of arrival. Best for short visits.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>**1-Year e-Tourist:** Multiple entry, allows 90 days stay per visit. Best for frequent travelers.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>**5-Year e-Tourist:** Multiple entry, long-term validity. Granted based on nationality.</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">South Asia Protocol 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  q="Can I get an Indian visa on arrival at the airport?" 
                  a="No. 'Visa on Arrival' in India actually refers to the e-Visa (ETA) which must be applied for and approved online *before* you board your flight." 
                />
                <FAQBox 
                  q="What is an ETA?" 
                  a="ETA stands for Electronic Travel Authorization. It is the official PDF document we send you once the Indian Government approves your application." 
                />
                <FAQBox 
                  q="Are GCC nationals (Emiratis, Saudis) eligible for e-Visa?" 
                  a="Yes, most GCC citizens are eligible for the e-Tourist visa. We process these within 24 hours for urgent travel." 
                />
                <FAQBox 
                  q="Does my passport need to be submitted physically?" 
                  a="For e-Visas, no. For sticker visas (required for certain work categories or long-term stay), physical submission at IVS Global/BLS in UAE is required." 
                />
                <FAQBox 
                  q="Can I enter India through any airport?" 
                  a="e-Visa holders must enter through 31 designated International Airports (including Delhi, Mumbai, Chennai, Kochi) and 5 Seaports." 
                />
                <FAQBox 
                  q="Is the visa fee refundable if rejected?" 
                  a="No. The Indian government processing fee is charged upon submission and is non-refundable regardless of the visa outcome." 
                />
              </div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-4 lg:sticky lg:top-8 self-start">
            ...
            <div className="mt-10 bg-[#f8fafc] border border-slate-100 rounded-[3rem] p-12 text-center flex flex-col items-center">
               ...
               <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.25em] mb-2">INDIA MISSION SERVICES</p>
