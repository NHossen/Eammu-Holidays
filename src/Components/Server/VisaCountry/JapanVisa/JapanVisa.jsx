      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-emerald-50 text-[#005a31] px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-emerald-100">
                <ShieldCheck size={14} /> Official 2026 VFS Partner
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                Japan Visa <br /> 
                <span className="text-[#ff6b00]">Land of Rising Sun.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Expert assistance for **UAE Residents**. From the new **Japan e-Visa** for eligible nationalities to **5-Year Multiple Entry** sticker visas, we handle the entire VFS Dubai appointment and documentation process.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl border border-slate-50 hidden md:block">
                ...
                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Success Ratio*</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="E-Visa Processing" value="3-5 Working Days" />
            <MetricBox icon={<Wallet />} label="Sticker Visa Fee" value="AED 75 (Excl. VFS)" />
            <MetricBox icon={<TrendingUp />} label="Indian Passport" value="Special Reduced Fee" />
            <MetricBox icon={<Globe />} label="E-Visa Eligibility" value="Online Portal" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">Japan Travel Guides</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="E-Visa vs Sticker" desc="Who is eligible for the digital Japan e-visa in 2026?" />
              <VideoCard id="mVo9V7RR5fE" title="NOC Requirements" desc="Why your employment letter is the key to approval." />
              <VideoCard id="NrSjr1GnotY" title="Multiple Entry Tips" desc="How to get a 5-year Japan visa from Dubai." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-[#005a31] mb-12 uppercase tracking-tighter">
              Japan <span className="text-[#ff6b00]">Visa Types</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                ...
                type="Digital" 
                title="Single Entry e-Visa" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1528360983277-13d401cdc186?q=80&w=800" 
                type="Standard" 
              ...
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1526481280693-3bfa7568e0f3?q=80&w=800" 
                type="Commercial" 
                title="Business Visa" 
              />
            </div>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">Required for VFS Global Dubai & Abu Dhabi</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="2 Photos (45mm x 35mm)" />
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="NOC Addressed to Consulate" />
                    <CheckItem text="3-Month Bank Statement" />
                    <CheckItem text="Salary Certificate (Official)" />
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Detailed Daily Itinerary" />
                    <CheckItem text="Confirmed Hotel Bookings" />
                    <CheckItem text="Flight Reservation (Round)" />
                    <CheckItem text="Japan Stay Schedule (Form)" />
                  </div>
                </div>
                ...
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Multiple Entry Eligibility (Up to 5 Years)</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="Previous Japan Travel Record" />
                      <CheckItem light text="Strong Monthly Salary Proof" />
                      <CheckItem light text="UAE Golden Visa (Preferred)" />
                      <CheckItem light text="Frequent Traveler Status" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    <strong className="text-[#005a31] font-black uppercase text-sm block mb-1">New 2026 Regulation:</strong> 
                    As of April 1, 2026, the consulate has updated its fee structure. **Indian nationals** continue to enjoy a 
                    reduced fee of just AED 20. The **Japan e-Visa** is now fully operational for Indians, Filipinos, and Vietnamese 
                    nationalities residing in the UAE, allowing for a completely digital application without submitting physical 
                    passports. However, multiple entry requests still require physical submission at VFS Global.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">Photo Specifications (Critical)</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">Japan is very strict regarding photo quality. Ensure yours meet these rules:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Size: Exactly 45mm x 35mm. No border.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Background: Plain white only (no grey, no shadows).</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Glued, not stapled, to the application form.</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">Japan Entry Protocol 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  q="Can I apply for a Japan e-Visa if I am Pakistani?" 
                  a="Currently, the Japan e-Visa portal only supports specific nationalities in the UAE (like India, Philippines, Brazil, etc.). Pakistani nationals must still apply for a physical sticker visa through VFS Global Dubai/Abu Dhabi." 
                />
                <FAQBox 
                  q="How much balance should I have in my bank?" 
                  a="While there is no official 'minimum', we recommend maintaining a closing balance of at least AED 25,000 to AED 30,000 for a single person's trip to show sufficient financial ties." 
                />
                <FAQBox 
                  q="Does the NOC need to be addressed to VFS?" 
                  a="No. The NOC/Employment letter must be specifically addressed to 'The Consul-General of Japan in Dubai' (or Abu Dhabi if your visa is issued there)." 
                />
                <FAQBox 
                  q="What is the validity of the Single Entry visa?" 
                  a="Once issued, you must enter Japan within 90 days. Upon entry, you are typically granted a stay of 15 or 30 days." 
                />
                <FAQBox 
                  q="Is an appointment mandatory at VFS Global?" 
                  a="Yes, you must book a biometric and submission appointment. However, if you are eligible for the e-Visa, everything is done online without an appointment." 
                />
                <FAQBox 
                  q="How long does processing take in peak season?" 
                  a="During the Cherry Blossom (March-April) and Autumn (October-November) seasons, processing can extend to 15 working days. Apply at least 4 weeks in advance." 
                />
              </div>
            </section>
          </div>
