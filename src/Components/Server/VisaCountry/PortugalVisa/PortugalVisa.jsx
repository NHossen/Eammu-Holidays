      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                Portugal Visa <br /> 
                <span className="text-[#ff6b00]">Your Gateway to EU.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Expert consultancy for **Schengen Tourist Visas**, **D8 Digital Nomad Permits**, and **Job Seeker Visas**. Experience the Atlantic charm with professional 2026-compliant guidance.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-[8px] border-white ring-1 ring-slate-100">
                <img 
                  src="https://images.unsplash.com/photo-1555881400-74d7acaacd8b?q=80&w=1200" 
                  alt="Lisbon, Portugal - Belem Tower" 
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl border border-slate-50 hidden md:block">
                ...
                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Approval Success</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="Schengen Time" value="15-20 Days" />
            <MetricBox icon={<Wallet />} label="Schengen Fee" value="€90 (Adult)" />
            <MetricBox icon={<TrendingUp />} label="Nomad Path" value="D8 Residency" />
            <MetricBox icon={<Globe />} label="Appointment" value="VFS Global DXB" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">Portugal Insights</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="Digital Nomad D8" desc="Income requirements for remote workers in 2026." />
              <VideoCard id="mVo9V7RR5fE" title="Job Seeker Visa" desc="How to look for work in Portugal legally for 180 days." />
              <VideoCard id="NrSjr1GnotY" title="Schengen Approval" desc="Proof of ties and financial docs for UAE residents." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-[#005a31] mb-12 uppercase tracking-tighter">
              Portugal <span className="text-[#ff6b00]">Pathways</span>
            </h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                img="https://images.unsplash.com/photo-1589779267444-40ef403fc63e?q=80&w=800" 
                type="Schengen C" 
                title="Short Stay" 
              />
              <PosterCard 
              ...
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1562184552-997c461abbe6?q=80&w=800" 
                type="National D" 
                title="Job Seeker" 
              />
              <PosterCard 
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h2 className="text-4xl font-black uppercase tracking-tight">Portugal Checklist</h2>
                    <p className="text-slate-500 font-medium mt-1">Core Documentation for AIMA & VFS</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="UAE Residency (3+ Months)" />
                    <CheckItem text="NIF (Tax ID) for Residency Visas" />
                    <CheckItem text="2 Passport Photos (35x45mm)" />
                  </div>
                </div>
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="Salary Slips / Remote Contract" />
                    <CheckItem text="Tax Return (Last Year)" />
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="Cover Letter (Motivation)" />
                    <CheckItem text="Criminal Record (Apostilled)" />
                  </div>
                </div>

                {/* 4. DIGITAL NOMAD & JOB SEEKER SPECIALS */}
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Residency & Long-Stay Extras</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="Portuguese Bank Account" />
                      <CheckItem light text="12-Month Rental Agreement" />
                      <CheckItem light text="Remote Work Proof (D8)" />
                      <CheckItem light text="IEFP Registration (Job Seeker)" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    <strong className="text-[#005a31] font-black uppercase text-sm block mb-1">Critical Insight:</strong> 
                    For the D8 Digital Nomad visa in 2026, the minimum income threshold is **€3,680 per month** (4x the national minimum wage). 
                    Applications without the official **NIF (Tax ID)** and a local Portuguese bank account are often delayed. We assist 
                    in obtaining these remotely.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">D8 Nomad vs. D7 Passive Income</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">Choosing the right long-stay pathway for your profile:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>**D8:** For those with remote employment or freelance contracts from outside Portugal.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>**D7:** For retirees or those with recurring passive income (Rentals, Dividends, Pensions).</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">Portugal Visa Protocol 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  q="How long is the Portugal Schengen processing time?" 
                  a="In the UAE, it typically takes 15-21 working days. However, during peak summer seasons, we recommend applying at least 45 days in advance." 
                />
                <FAQBox 
                  q="What is the Portugal Job Seeker Visa?" 
                  a="It allows you to enter Portugal for 120 days (extendable by 60) to look for work. You must register with the IEFP and show financial means (approx €3,000+)." 
                />
                <FAQBox 
                  q="Do I need to visit the Embassy?" 
                  a="For most applicants in the UAE, you will visit VFS Global in Dubai or Abu Dhabi for biometrics. The Embassy/Consulate handles the final decision." 
                />
                <FAQBox 
                  q="Can I include my family on a Digital Nomad Visa?" 
                  a="Yes! Portugal allows family reunification for spouses and dependent children, though you must show additional financial savings for each member." 
                />
                <FAQBox 
                  q="What is an Apostilled Criminal Record?" 
                  a="It is an official background check from your country of residence that has been legalized for international use. It is mandatory for all residency visas." 
                />
                <FAQBox 
                  q="What is the 'AIMA' appointment?" 
                  a="AIMA (formerly SEF) is the immigration authority in Portugal. If you get a Residency Visa, you must attend an appointment in Portugal to get your physical card." 
                />
              </div>
            </section>
          </div>
