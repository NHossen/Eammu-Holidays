      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                USA Visa <br /> 
                <span className="text-[#ff6b00]">Success Simplified.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Expert consultancy for <strong>B1/B2 Visitor Visas</strong>, <strong>F1 Student Visas</strong>, and <strong>Employment Petitions</strong>. We navigate the DS-160 and interview prep for you.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-[8px] border-white ring-1 ring-slate-100">
                <img 
                  src="https://images.unsplash.com/photo-1485738422979-f5c462d49f74?q=80&w=1200" 
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl border border-slate-50 hidden md:block">
                ...
                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Interview Success</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="Appointment" value="Varies by City" />
            <MetricBox icon={<Wallet />} label="MRV Fee" value="$185 (B1/B2)" />
            <MetricBox icon={<TrendingUp />} label="Approval Rate" value="92.4%" />
            <MetricBox icon={<Globe />} label="Service" value="Full Prep" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">USA Application Guide</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="Interview Secrets" desc="How to answer the Consular Officer's questions with confidence." />
              <VideoCard id="mVo9V7RR5fE" title="Dubai To USA" desc="Booking appointments and DS-160 tips for UAE residents." />
              <VideoCard id="NrSjr1GnotY" title="F1 Student Tips" desc="Mastering the SEVIS process and financial documentation." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-[#005a31] mb-12 uppercase tracking-tighter">
              US Visa <span className="text-[#ff6b00]">Programs</span>
            </h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                img="https://images.unsplash.com/photo-1508433957232-3107f5ed2035?q=80&w=800" 
                type="Non-Immigrant" 
                title="B1/B2 Visitor" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1541339907198-e08759dfc3ef?q=80&w=800" 
                type="Educational" 
                title="F1 Student" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1521791136064-7986c2959210?q=80&w=800" 
                type="Business" 
                title="E2 / L1 / H1-B" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1501594907352-04cda38ebc29?q=80&w=800" 
                type="Employment" 
                title="Green Card EB" 
              />
            </div>
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">Essential documents for your US Embassy interview</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="DS-160 Confirmation Page" />
                    <CheckItem text="Appointment Confirmation" />
                    <CheckItem text="2x2 Inch US-Spec Photo" />
                  </div>
                </div>

                {/* 2. FINANCIAL PROOF */}
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Financial Ties</h4>
                  <div className="space-y-4">
                    <CheckItem text="6 Months Bank Statements" />
                    <CheckItem text="Employment Verification Letter" />
                    <CheckItem text="Salary Certificates / Payslips" />
                    <CheckItem text="Property or Business Assets" />
                  </div>
                </div>
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Proposed Travel Schedule" />
                    <CheckItem text="Conference / Event Invites" />
                    <CheckItem text="Family Contact Info in USA" />
                    <CheckItem text="Previous US Visas (Expired)" />
                  </div>
                </div>
                ...
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Student & Work Petitions (F, M, J, H, L)</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="I-20 Form (For Students)" />
                      <CheckItem light text="SEVIS Fee Payment Receipt" />
                      <CheckItem light text="I-797 Approval Notice" />
                      <CheckItem light text="Degree & Academic Transcripts" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    <strong className="text-[#005a31] font-black uppercase text-sm block mb-1">Crucial Note:</strong> 
                    US visas are decided primarily during the 2-minute interview. Documents are supporting evidence, but your verbal 
                    clarity is key. Our <strong>Mock Interview Sessions</strong> in Dubai and Yerevan significantly increase approval odds.
                  </p>
                </div>
              </div>
            </section>

            {/* ESTA / Visa Waiver Info */}
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">ESTA Visa Waiver Program</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">Citizens of participating countries (VWP) may travel to the US for 90 days without a visa:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Includes UK, EU, Australia, Japan, South Korea, and more.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Must apply for ESTA authorization online at least 72 hours before departure.</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">USA Immigration FAQs 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  ...
                  a="Wait times vary by embassy. In Dubai and Yerevan, slots can be booked several months out. We offer an expedited tracking service for cancelled slots." 
                />
                <FAQBox 
                  q="Does a previous rejection affect my new application?" 
                  a="Yes, you must disclose it. However, many of our clients obtain visas after previous refusals by showing a change in 'Strong Ties' to their home country." 
                />
                <FAQBox 
                  q="How long is the B1/B2 visa valid for?" 
                  a="Most nationalities receive a 5 or 10-year multiple-entry visa. Each visit typically allows a maximum stay of 6 months, determined at the border." 
                />
                <FAQBox 
                  q="Can I apply for a US visa while on a visit visa in UAE?" 
                  a="Generally, the US Embassy prefers you apply in your country of residence. However, 'Third Country Nationals' (TCNs) can apply in Dubai/Abu Dhabi if they have valid residency." 
                />
                <FAQBox 
                  q="What is the 221(g) administrative processing?" 
                  a="This is a temporary hold for additional background checks. It doesn't mean a rejection. We assist in submitting any further documents requested via the consulate." 
                />
                <FAQBox 
                  q="What is the 2x2 photo requirement?" 
                  a="The US has strict photo specs: 51x51mm, white background, no glasses, taken within the last 6 months. We ensure your digital photo passes the DS-160 validation." 
                />
              </div>
            </section>
          </div>
