      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-emerald-50 text-[#005a31] px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-emerald-100">
                <ShieldCheck size={14} /> 2026 MAGHREB TRAVEL SPECIALIST
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                Morocco Visa <br /> 
                <span className="text-[#ff6b00]">Atlas Adventure.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Expert assistance for **E-Visas** via Access Maroc and **Sticker Visas** via the Moroccan Consulate in Dubai. We specialize in documentation for UAE residents seeking to explore Marrakech, Casablanca, and beyond.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-[8px] border-white ring-1 ring-slate-100">
                <img 
                  src="https://images.unsplash.com/photo-1489749798305-4fea3ae63d43?q=80&w=1200" 
                  alt="Marrakech Medina, Morocco" 
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl border border-slate-50 hidden md:block">
                <p className="text-[#005a31] font-black text-3xl">3-10</p>
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="E-Visa Speed" value="24-72 Hours" />
            <MetricBox icon={<Wallet />} label="Sticker Fee" value="~AED 120 - 350" />
            <MetricBox icon={<TrendingUp />} label="E-Visa Validity" value="180 Days (Single)" />
            <MetricBox icon={<Globe />} label="UAE Resident Status" value="Special Entry Rules" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">Morocco Travel Hub</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="E-Visa vs Sticker" desc="Identifying the right Moroccan entry permit for your passport." />
              <VideoCard id="mVo9V7RR5fE" title="Consulate Procedures" desc="How to book appointments at the Morocco Consulate in Dubai." />
              <VideoCard id="NrSjr1GnotY" title="Chefchaouen Guide" desc="Logistics for visiting the Blue City and Northern Morocco." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              ...
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1504198458649-012803d36895?q=80&w=800" 
                type="E-Visa" 
                title="Instant Access" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1548133061-686955030642?q=80&w=800" 
                type="Business" 
                title="Trade & Commerce" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1559586616-361e18714958?q=80&w=800" 
                type="Student" 
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Passport (Valid 6M+)" />
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Original NOC from UAE Sponsor" />
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="Comprehensive Travel Ins." />
                    <CheckItem text="Detailed Trip Itinerary" />
                  </div>
                </div>
                ...
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Morocco E-Visa Waiver 2026</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="Valid Multiple Schengen Visa" />
                      <CheckItem light text="Valid US / UK / Canada Visa" />
                      <CheckItem light text="Selected Nationalities List" />
                      <CheckItem light text="90 Days Validity from Issue" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    <strong className="text-[#005a31] font-black uppercase text-sm block mb-1">Electronic Submission Note:</strong> 
                    For 2026, many nationalities with a valid residency/visa from the EU, US, UK, Australia, or Japan can apply for the **E-Visa (Access Maroc)**. This process is 100% online and does not require a consulate visit. If you do not meet these criteria, a physical Sticker Visa application is mandatory. We provide file-vetting for both routes.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">Sticker Visa Appointment Protocol</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">For those requiring a physical stamp in the passport:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Applicants must book an appointment at the Moroccan Consulate in Dubai or Abu Dhabi.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>The presence of the applicant may be requested for a brief interview.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Standard processing is 10-15 working days; Express options are subject to consulate approval.</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">North Africa Protocol 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  q="Do UAE Nationals need a visa for Morocco?" 
                  a="No. UAE Citizens are visa-exempt for touristic stays up to 90 days. UAE Residents (Expats) depend on their original passport nationality." 
                />
                <FAQBox 
                  q="How fast is the E-Visa (Access Maroc)?" 
                  a="The E-Visa is typically issued within 24 to 72 hours. It is valid for a single entry and a stay of up to 30 days." 
                />
                <FAQBox 
                  q="Is the bank statement mandatory for UAE residents?" 
                  a="Yes, a 3-month stamped bank statement is a core requirement for the Sticker Visa to prove financial solvency during the trip." 
                />
                <FAQBox 
                  q="Can I enter Morocco via the land border from Spain?" 
                  a="Yes, but ensure your visa is 'Multiple Entry' if you plan to exit and re-enter, or check the specific port of entry rules for E-Visa holders." 
                />
                <FAQBox 
                  q="What is the validity of the Sticker Visa?" 
                  a="Typically, it is granted for 30 to 90 days. The validity and duration are at the sole discretion of the Moroccan Consulate." 
                />
                <FAQBox 
                  q="Does the NOC need to be in French or Arabic?" 
                  a="While English is generally accepted in Dubai, having a French translation can sometimes speed up the process at the Ministry level in Morocco." 
                />
              </div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-4 lg:sticky lg:top-8 self-start">
            ...
            <div className="mt-10 bg-[#f8fafc] border border-slate-100 rounded-[3rem] p-12 text-center flex flex-col items-center">
               ...
               <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.25em] mb-2">MOROCCO MISSION SERVICES</p>
