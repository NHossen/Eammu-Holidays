      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-emerald-50 text-[#005a31] px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-emerald-100">
                <ShieldCheck size={14} /> 2026 CAUCASUS TRAVEL EXPERT
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                Azerbaijan <br /> 
                <span className="text-[#ff6b00]">Land of Fire.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Instant **ASAN e-Visa** processing for over 95 nationalities. Whether you are visiting the futuristic flames of Baku or the historic hills of Sheki, we handle your official portal registration in under 3 hours.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-[8px] border-white ring-1 ring-slate-100">
                <img 
                  src="https://images.unsplash.com/photo-1527068596702-8f98c7177508?q=80&w=1200" 
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl border border-slate-50 hidden md:block">
                <p className="text-[#005a31] font-black text-3xl">3-72</p>
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="Standard Speed" value="3 Working Days" />
            <MetricBox icon={<Wallet />} label="Total Fee" value="~AED 150 - 350" />
            <MetricBox icon={<TrendingUp />} label="Stay Period" value="30 Days (Single)" />
            <MetricBox icon={<Globe />} label="E-Visa Status" value="ASAN Official Portal" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">Discover Azerbaijan</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="ASAN Visa Guide 2026" desc="Step-by-step walkthrough of the electronic visa portal for Baku." />
              <VideoCard id="mVo9V7RR5fE" title="Migration Registration" desc="Important: Rules for staying longer than 15 days in Azerbaijan." />
              <VideoCard id="NrSjr1GnotY" title="Winter in Shahdag" desc="Skiing and visa requirements for the northern resort regions." />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white w-full">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black text-[#005a31] mb-12 uppercase tracking-tighter">
              Baku <span className="text-[#ff6b00]">Passports</span>
            </h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                img="https://images.unsplash.com/photo-1549488497-256795400907?q=80&w=800" 
                type="Standard" 
                title="Tourist E-Visa" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1623910543232-a56767769634?q=80&w=800" 
                type="Urgent" 
                title="3-Hour Fast Track" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1618671569420-424a9192f96e?q=80&w=800" 
                type="Business" 
                title="Commercial Visit" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?q=80&w=800" 
                type="Culture" 
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">Azerbaijan E-Visa Documents 2026</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Clear Passport Scan" />
                    <CheckItem text="Min. 6 Months Validity" />
                    <CheckItem text="Digital Studio Photo" />
                    <CheckItem text="Emirates ID (if resident)" />
                  </div>
                </div>
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Hotel Name & Address" />
                    <CheckItem text="Intended Entry Date" />
                    <CheckItem text="Contact Phone Number" />
                    <CheckItem text="Flight Ticket (Optional)" />
                  </div>
                </div>
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Visa Processing Fee" />
                    <CheckItem text="Valid Email Address" />
                    <CheckItem text="Travel Insurance" />
                    <CheckItem text="Entry Stamp Check" />
                  </div>
                </div>
                ...
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Registration Protocol 2026</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="Register if stay > 15 days" />
                      <CheckItem light text="ASAN Service Center" />
                      <CheckItem light text="State Migration Portal" />
                      <CheckItem light text="Avoid Overstay Fines" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    <strong className="text-[#005a31] font-black uppercase text-sm block mb-1">Important Migration Rule:</strong> 
                    Foreigners and stateless persons staying in the Republic of Azerbaijan for **more than 15 days** must be registered at the place of stay. This can be done by your hotel or through the State Migration Service website. Failure to register within the first 15 days of arrival will result in significant fines and potential deportation. 
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">ASAN E-Visa Categories</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">Azerbaijan offers two speeds for electronic applications:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>**Standard E-Visa:** Issued within 3 working days. Perfect for planned vacations.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>**Urgent E-Visa:** Issued within 3 hours (including weekends and holidays).</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>**Sticker Visa:** Required for work or long-term residence, processed at the Embassy.</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">Baku Protocol 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  q="Do UAE Nationals need a visa for Azerbaijan?" 
                  a="UAE Citizens get a visa on arrival at international airports in Azerbaijan. UAE Residents (Expats) must apply for the E-Visa before traveling." 
                />
                <FAQBox 
                  q="How much is the Azerbaijan E-Visa?" 
                  a="The standard fee is approximately AED 150, while the Urgent (3-hour) visa is approximately AED 350, including service charges." 
                />
                <FAQBox 
                  q="Is the E-Visa valid for land borders?" 
                  a="In 2026, land borders may have specific restrictions. It is highly recommended to fly into Heydar Aliyev International Airport (Baku)." 
                />
                <FAQBox 
                  q="Can I perform business tasks on a tourist visa?" 
                  a="A tourist visa is for leisure. For trade fairs, meetings, or contracts, you should select the 'Business' purpose on the ASAN portal." 
                />
                <FAQBox 
                  q="What is the validity of the ASAN E-Visa?" 
                  a="The visa is valid for 90 days from the date of issue, allowing a single entry stay of up to 30 days." 
                />
                <FAQBox 
                  q="Can I apply for a visa if I visited Armenia?" 
                  a="Yes, but having a stamp from Nagorno-Karabakh without official Azerbaijani permission may lead to entry denial and being blacklisted." 
                />
              </div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-4 lg:sticky lg:top-8 self-start">
            ...
            <div className="mt-10 bg-[#f8fafc] border border-slate-100 rounded-[3rem] p-12 text-center flex flex-col items-center">
               ...
               <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.25em] mb-2">AZERBAIJAN MISSION SERVICES</p>
