      ...
      <main className="bg-white min-h-screen font-sans text-slate-900 selection:bg-orange-100">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-emerald-50 text-[#005a31] px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-emerald-100">
                <ShieldCheck size={14} /> Official 2026 E-Visa Agent
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#005a31] mb-6 leading-[1.1] tracking-tight">
                Indonesia Visa <br /> 
                <span className="text-[#ff6b00]">Wonderful Bali.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed font-medium">
                Fast-track **E-VOA** and B211A Tourist Visas for 2026. We manage your **Molina** portal registration, Bali Tourist Levy, and electronic customs declarations for a seamless arrival.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl border border-slate-50 hidden md:block">
                <p className="text-[#005a31] font-black text-3xl">1-2</p>
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <MetricBox icon={<Clock />} label="E-VOA Speed" value="24-48 Hours" />
            <MetricBox icon={<Wallet />} label="B211A Visa Fee" value="~AED 950 (60 Days)" />
            <MetricBox icon={<TrendingUp />} label="Stay Period" value="30 to 60 Days" />
            <MetricBox icon={<Globe />} label="Bali Entry" value="Tax & Customs QR" />
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-slate-50/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#005a31] uppercase tracking-tighter mb-4">Explore Indonesia 2026</h2>
              <div className="h-1.5 w-20 bg-[#ff6b00] mx-auto rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <VideoCard id="98fSRoZIkWs" title="E-VOA vs B211A" desc="Which visa type fits your 2026 travel duration?" />
              <VideoCard id="mVo9V7RR5fE" title="Bali Tourism Levy" desc="How to pay the mandatory IDR 150,000 tax online." />
              <VideoCard id="NrSjr1GnotY" title="Jakarta to Gili" desc="Internal travel protocols and electronic customs guides." />
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full items-stretch">
              <PosterCard 
                ...
                type="E-VOA" 
                title="30-Day Tourist" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1555400038-63f5ba517a47?q=80&w=800" 
                type="B211A" 
                title="60-Day Visit" 
              />
              <PosterCard 
                img="https://images.unsplash.com/photo-1539367628448-4bc5c9d171c8?q=80&w=800" 
                type="Remote Work" 
                title="Digital Nomad" 
              />
              <PosterCard 
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-20">
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">Required Digital Documents 2026</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    <CheckItem text="Passport (Full Page Scan)" />
                    <CheckItem text="Min. 6 Months Validity" />
                    <CheckItem text="Passport-Size Digital Photo" />
                    <CheckItem text="UAE Visa & EID Scans" />
                  </div>
                </div>
                ...
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <CheckItem text="Min. Balance $2,000" />
                    <CheckItem text="NOC from UAE Employer" />
                    <CheckItem text="Proof of Funds (for B211A)" />
                  </div>
                </div>

                {/* 3. LOGISTICS */}
                <div className="bg-[#f8fafc] p-8 rounded-[2.5rem] border border-slate-100 hover:border-emerald-200 transition-colors">
                  <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Arrival</h4>
                  <div className="space-y-4">
                    <CheckItem text="Confirmed Return Flight" />
                    <CheckItem text="Hotel Booking Voucher" />
                    <CheckItem text="Electronic Customs (e-CD)" />
                    <CheckItem text="SATUSEHAT App Install" />
                  </div>
                </div>

                {/* 4. BALI SPECIAL STATUS BOX */}
                <div className="bg-[#005a31] md:col-span-3 p-8 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-[#ff5722] font-black text-xs uppercase tracking-[0.2em] mb-6">Bali Entry Protocol 2026</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <CheckItem light text="Mandatory Tourist Levy" />
                      <CheckItem light text="IDR 150k Payment QR" />
                      <CheckItem light text="Customs Declaration QR" />
                      <CheckItem light text="Health Declaration Pass" />
                    </div>
                  </div>
              ...
              <div className="mt-10 p-8 bg-orange-50 border border-orange-100 rounded-[2rem] flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p className="text-base text-slate-700 font-medium leading-relaxed">
                    <strong className="text-[#005a31] font-black uppercase text-sm block mb-1">Attention Bali Travelers:</strong> 
                    As of 2026, all international tourists entering Bali must pay the **International Tourism Levy** (approx. $10 USD). This is in addition to your visa fee. We recommend paying this online through the official "Love Bali" 
                    portal before you land to avoid long queues at Ngurah Rai International Airport. We include this payment assistance in our Bali VIP package.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-emerald-50 rounded-[2.5rem] p-8 md:p-12 border border-emerald-100">
               <h3 className="text-2xl font-black text-[#005a31] mb-6 tracking-tight uppercase">Stay & Extension Rules</h3>
               <p className="text-slate-700 leading-relaxed mb-6 font-medium">Indonesia has modernized its visa extension system for 2026:</p>
               <ul className="space-y-4">
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>E-VOA: 30 days initial stay, extendable once for 30 more days online.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>B211A: 60 days initial stay, extendable twice for 60 days each.</span></li>
                  <li className="flex gap-3 items-start"><CheckCircle size={18} className="text-[#ff6b00] mt-1" /> <span>Overstaying results in a penalty of IDR 1,000,000 per day.</span></li>
               </ul>
            </div>
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b-2 border-slate-100 pb-8">
                <div>
                  ...
                  <p className="text-[#ff5722] font-black uppercase text-xs tracking-[0.2em] mt-2">ASEAN Protocol 2026</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FAQBox 
                  ...
                  a="Yes, most nationalities can get VOA on arrival for $35, but we recommend applying for the E-VOA online 48 hours before travel to bypass airport payment queues." 
                />
                <FAQBox 
                  q="Do I need a sponsor for a tourist visa?" 
                  a="For the standard 30-day E-VOA, no sponsor is needed. For the 60-day B211A visa, an Indonesian guarantor or agency (like Eammu Holidays) is required." 
                />
                <FAQBox 
                  q="What is the SATUSEHAT Health Pass?" 
                  a="It is Indonesia's mandatory health reporting app. You must fill out the self-declaration form within 48 hours of your flight to generate a QR code for entry." 
                />
                <FAQBox 
                  q="Is travel insurance mandatory for Indonesia?" 
                  a="While not strictly mandatory for all, it is highly recommended and required for B211A applicants. It must cover COVID-19 and medical emergencies." 
                />
                <FAQBox 
                  q="Can I work remotely on a tourist visa?" 
                  a="For true 'Digital Nomad' stays, Indonesia has launched specific Remote Work visas. Standard tourist visas are strictly for leisure and business meetings." 
                />
                <FAQBox 
                  q="What is the Electronic Customs Declaration?" 
                  a="Paper forms are no longer used. You must complete the e-CD online to get a QR code for your luggage clearance after immigration." 
                />
              </div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-4 lg:sticky lg:top-8 self-start">
            ...
            <div className="mt-10 bg-[#f8fafc] border border-slate-100 rounded-[3rem] p-12 text-center flex flex-col items-center">
               ...
               <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.25em] mb-2">INDONESIA MISSION SERVICES</p>
